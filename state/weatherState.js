class WeatherState extends DefaultState {
    constructor(state, redMode) {
      ...
      const names = ["Quality of Stargazing","Temperature","Cloud Cover","Rain","Visability","Fod Level","Light Level"];
      const data = ["Excellent","15\u{00B0}C","10%","6% Chance","20Km","Low","Dark"];
      ...
      for (let i = 0; i < 7; i ++) {
        ...
        this.addText(data[i],10,21 + inc * i,8,colour(180, 200, 220))
      }
